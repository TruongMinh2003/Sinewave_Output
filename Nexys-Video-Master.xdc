...
set_property -dict { PACKAGE_PIN Y13   IOSTANDARD LVCMOS25 } [get_ports { i2c_DONE }]; #IO_L5P_T0_13 Sch=led[7]
...
## Switches
set_property -dict { PACKAGE_PIN F21  IOSTANDARD LVCMOS12 } [get_ports { i2c_start }]; #IO_25_16 Sch=sw[1]
...
set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 } [get_ports { BCLK_0 }]; #IO_L14P_T2_SRCC_34 Sch=ac_bclk
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { sdata_0 }]; #IO_L15P_T2_DQS_34 Sch=ac_dac_sdata
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { LRCLK_0 }]; #IO_L14N_T2_SRCC_34 Sch=ac_lrclk
set_property -dict { PACKAGE_PIN U6    IOSTANDARD LVCMOS33 } [get_ports { MCLK_0 }]; #IO_L16P_T2_34 Sch=ac_mclk


## Pmod header JA
set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { BCLK_0 }]; #IO_L10N_T1_D15_14 Sch=ja[1]
set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { LRCLK_0 }]; #IO_L10P_T1_D14_14 Sch=ja[2]
set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { sdata_0 }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { SCL_0 }]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]
set_property -dict { PACKAGE_PIN Y21   IOSTANDARD LVCMOS33 } [get_ports { SDA_0 }]; #IO_L9P_T1_DQS_14 Sch=ja[7]
...
## I2C
set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { SCL_0 }]; #IO_L15N_T2_DQS_34 Sch=scl
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { SDA_0 }]; #IO_L16N_T2_34 Sch=sda
